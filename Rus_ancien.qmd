...
<qgis version="3.42.1-Münster">
  <identifier>rus_1820_modifié</identifier>
  <parentidentifier></parentidentifier>
  <language>FRA</language>
  <type>dataset</type>
  <title>fr_dpt93_727</title>
  <abstract>Rus figurés sur le cadastre napoléonien et/ou sur les minutes de la carte d'Etat-major (1818-1820). (EAU / ASSAINISSEMENT)

Hydrographie 1820 (rus)</abstract>
  <links/>
  <dates/>
  <fees></fees>
  <encoding></encoding>
